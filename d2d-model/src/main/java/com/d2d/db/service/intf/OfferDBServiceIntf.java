...
public interface OfferDBServiceIntf {
    ...
    public void updateImagePath(long var1, String var2) throws DBServiceException;
	/**
	 * @param categoryModel
	 */
	public void addCategory(CategoryModel categoryModel) throws DBServiceException;
	
	public CategoryModel getCatgoryById(Integer var1) throws DBServiceException;
	...
	public List<CategoryModel> getCategoriesByParentId(Integer var1) throws DBServiceException;
	...
	public void updateCategoryOffer(String var1, Integer var2) throws DBServiceException;
}
