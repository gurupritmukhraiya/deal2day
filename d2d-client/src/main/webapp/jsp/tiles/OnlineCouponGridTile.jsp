...
$.each(onlineData.dotdList, function( index, value ) {
 if(value.description != null && value.description != "" && noOfOffers <= 7){
  ...
  column += '<div style="font-size: 14px; text-transform: uppercase; color: #333; font-weight: bold; width: 100%;padding:5px;height: 60px;text-align: justify;">'+value.description + ' @ ' + value.title + '</div>';
...
<div style="padding:10px" class="col-md-3">
	<div style="background: none repeat scroll 0% 0% rgb(255, 255, 255); border: 1px solid rgb(221, 221, 221); box-shadow: 0px 0px 12px -2px rgb(125, 125, 125); height: 200px;">
		<img alt="Hair Dryer" src="http://image.deal2day.in/app_fk.png" style="width:100%;" class="img-responsive">
		<div style="font-size: 14px; text-transform: uppercase; color: #333; font-weight: bold; width: 100%;padding:5px;height: 60px;">Get Flikart App Now</div>
		<div onclick="window.open('http://affiliate.flipkart.com/install-app?affid=gurupritm')" style=" width: 100%;" class="btn btn-primary">VIEW DEAL</div>
		<div class="clear"></div>
	</div>
</div>
