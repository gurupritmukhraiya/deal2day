...
<div class="row" style="display:none;" id="offer-add-d" >	
	...
	<div id="offer-request-ride-div">
		...
		<form class="form-horizontal" id="offer-add-f" method="post" action="${context}/imageUpload/addOffer.htm" enctype="multipart/form-data">
		...
		<c:if test="${not empty categories}">
			...
			<div class="form-group">
		  	...
		  	<div class="form-group">
	    		...
	    		<div class="col-sm-5">
	      			<input type="file" name="menu" id="addOfferImageInput" class="form-control" style="height:auto;">	        		
		        </div>
		  	</div>
